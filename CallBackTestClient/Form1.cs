...
namespace EchoClient
{
    public partial class Form1 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            connection.On<string, string, string>("EchoReceive", EchoReceive);           
        ...
        void EchoReceive(string userId, string message, string timestamp)
        {
            Invoke((Action)(() =>
            {
                listBox1.Items.Add($"[{timestamp}] {userId}:  {message}");
                button1.Enabled = true;
            }));
        }
